...
fetch4.addEventListener("click", () => {
  ...
  const url =
    "https://front.apirecette.digitick-ppe.com/v1.1/order/carts/288019424/entries/createByPrices";
...
fetch5.addEventListener("click", () => {
  const url =
    "https://front.apirecette.digitick-ppe.com/v1.1/order/carts/288019424/salesChannels/13357/check?userId=77204063";
...
showPanier.addEventListener("click", () => {
  const url = "https://front.apirecette.digitick-ppe.com/v1.1/order/carts/288019424";
...
fetch6.addEventListener("click", () => {
  ...
  const url =
    "https://front.apirecette.digitick-ppe.com/v1.1/order/transactions/carts/288019424/createOrderFromCart";
